...
function Story({ photoURL, username }) {
    return (
        <div className='flex flex-col w-16  group cursor-pointer'>
            <div className="rounded-full group-hover:scale-110 transition ease-in aspect-square w-fit bg-gradient-to-tr from-yellow-400 to-pink-500 p-1 grid place-items-center">
